...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "ytscxwt1h1s3dx2wtt41t8m2rdseudfka1qaspyfm8yjma2ad6uh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Battle Grid"),
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "battle grid"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://github.com/zenhack/dndgrid",
      # This should be the app's main website url.

      codeUrl = "https://github.com/zenhack/dndgrid",
      ...
      shortDescription = (defaultText = "D&D battle grid"),
